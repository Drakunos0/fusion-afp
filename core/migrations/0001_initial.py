# Generated by Django 3.1.2 on 2020-10-21 02:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('ini-users', 'Usuários'), ('ini-layers', 'Design'), ('ini-mobile', 'Mobile'), ('ini-rocket', 'Foguete'), ('ini-cog', 'Engrenagem'), ('ini-stats-up', 'Grafico')], max_length=12, verbose_name='Icone')),
            ],
            options={
